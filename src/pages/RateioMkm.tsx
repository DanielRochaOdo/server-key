  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <ModuleHeader
        ...
        title="Rateio Fatura MKM"
        subtitle={COMPETENCIA_LABEL}
        actions={(
          <>
                ...
                {displayRows.map((row, index) => {
                  ...
                  return (
                    <tr
                      ...
                      className={`border-b border-neutral-100 last:border-b-0 ${isTotal ? 'font-semibold bg-neutral-200' : ''}`}
                    >
            ...
            <div className="p-3 sm:p-4 space-y-3 sm:space-y-4 flex-1">
              ...
              <div className="w-full">
                <table className="w-full table-fixed text-[11px] sm:text-xs">
                  ...
                  <tbody>
                    {formRows.map((row) => (
                      <tr key={row.id} className="border-b border-neutral-100 last:border-b-0">
                        ...
                        <td className="py-1 pr-2 sm:pr-4">
                          <div className="px-2 py-0.5 rounded-md bg-neutral-200 border border-neutral-200 text-neutral-700">
                  ...
                  <tfoot>
                    <tr className="border-t border-neutral-200 font-semibold bg-neutral-200">
